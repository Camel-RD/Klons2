...
namespace KlonsF.Classes
{
    ...
    public class OPSSheetConfig : SheetConfig, IFieldHelper
    {
        ...
        {
            return KlonsData.St.DataSetKlonsF.OPSd.Columns[name];
        }
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.OPS);
        ...
        public override void UseRow(object[] valuerow)
        {
            ...
            var dr_ops = KlonsData.St.DataSetKlonsF.OPS.NewOPSRow();
            SetDataRowFieldsA(dr_ops, valuerow, "AC11", "DESCR");
            dr_ops.DocId = lastOPSdId;
            dr_ops.ZDt = DateTime.Now;
            KlonsData.St.DataSetKlonsF.OPS.Rows.Add(dr_ops);
    ...
    public class AC1SheetConfig : SheetConfig
    {
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.AcP21);
        }

        public override ERowKind GetRowKind(object[] valuerow)
        {
            var table = KlonsData.St.DataSetKlonsF.AcP21;
    ...
    public class AC3SheetConfig : SheetConfig
    {
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.Acp23);
        }
    ...
    public class AC4SheetConfig : SheetConfig
    {
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.AcP24);
        }

        public override ERowKind GetRowKind(object[] valuerow)
        {
            var table = KlonsData.St.DataSetKlonsF.AcP24;
    ...
    public class AC5SheetConfig : SheetConfig
    {
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.Acp25);
        }

        public override ERowKind GetRowKind(object[] valuerow)
        {
            var table = KlonsData.St.DataSetKlonsF.Acp25;
            string idx = (string)valuerow[0];
            var dr = table.FindByidx(idx);
            if (dr == null) return ERowKind.New;
            if (EqualsDataRowFields(dr, valuerow)) return ERowKind.Existing;
    ...
    public class PersonsSheetConfig : SheetConfig
    {
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.Persons);
        }

        public override ERowKind GetRowKind(object[] valuerow)
        {
            var table = KlonsData.St.DataSetKlonsF.Persons;
    ...
    public class DocTypSheetConfig : SheetConfig
    {
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.DocTyp);
        }

        public override ERowKind GetRowKind(object[] valuerow)
        {
            var table = KlonsData.St.DataSetKlonsF.DocTyp;
    ...
    public class CurrencySheetConfig : SheetConfig
    {
        ...
        public override void Init()
        {
            ...
            ApplyFrom(KlonsData.St.DataSetKlonsF.Currency);
        }

        public override ERowKind GetRowKind(object[] valuerow)
        {
            var table = KlonsData.St.DataSetKlonsF.Currency;
            string id = (string)valuerow[0];
