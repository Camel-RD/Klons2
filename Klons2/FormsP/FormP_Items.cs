...
namespace KlonsP.Forms
{
    public partial class FormP_Items : MyFormBaseF
    {
        ...
        {
            var table_itemsevents = MyData.DataSetKlonsP.ITEMS_EVENTS;
        ...
        public void RecalcAll()
        {
            ...
            var table_items = MyData.DataSetKlonsP.ITEMS;
        ...
        public void AddItem()
        {
            ...
            var table_items = MyData.DataSetKlonsP.ITEMS;
            var table_events = MyData.DataSetKlonsP.ITEMS_EVENTS;
        ...
        public void AddEvent()
        {
            ...
            var dt = fm.Date;
            int evid = fm.EventId;
            var table = MyData.DataSetKlonsP.ITEMS_EVENTS;
        ...
        public void CheckChildGrid(bool setnull = false)
        {
                ...
                )
            {
                ...
                bsRows.DataSource = new DataView(MyData.DataSetKlonsP.ITEMS_EVENTS, null, null, DataViewRowState.None);
        ...
        public void DoFilter()
        {
            ...
            {
                string fs1 = "";
                var drf = MyData.DataSetKlonsP.CAT1.FindByID(filterData1.fCAT1.Value);
                if (drf.GROUP == 0)
                {
            ...
            {
                string fs1 = "";
                var drf = MyData.DataSetKlonsP.DEPARTMENTS.FindByID(filterData1.fDEPARTMENT.Value);
                if (drf.GROUP == 0)
                {
            ...
            {
                string fs1 = "";
                var drf = MyData.DataSetKlonsP.PLACES.FindByID(filterData1.fPLACE.Value);
                if (drf.GROUP == 0)
                {
