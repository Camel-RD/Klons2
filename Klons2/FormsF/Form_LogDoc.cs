...
namespace KlonsF.Forms
{
    public partial class Form_LogDoc : MyFormBaseF
    {
        ...
        private klonsDataSet MyDataSet => MyData.DataSetKlonsF;
        ...
        {
            var ad_docs = MyData.GetKlonsFAdapter("LOPSD") as LOPSdTableAdapter;
            var ad_rows = MyData.GetKlonsFAdapter("LOPS") as LOPSTableAdapter;
