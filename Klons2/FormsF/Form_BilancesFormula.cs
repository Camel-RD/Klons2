...
namespace KlonsF.Forms
{
    public partial class Form_BilancesFormula : MyFormBaseF
    {
        public Form_BilancesFormula()
        {
            ...
            MyData.DataSetKlonsF.BalA1.Clear();
            bsBalA1.Fill();
            bsBalA2.Fill();
            bsBalA3.Fill();
        ...
        private void DoCopy()
        {
            ...
            if (newid == "" || newid.Length > 10 ||
                MyData.DataSetKlonsF.BalA1.FindBybalid(newid) != null)
            {
        ...
        private void bsBalA2_MyBeforeRowInsert(MyRowUpdateEventArgs e)
        {
            ...
            if (dr == null) return;
            dr.id = (int)MyData.KlonsFQueriesTableAdapter.SP_BALA2_ID();
        }
        ...
        private void bsBalA3_MyBeforeRowInsert(MyRowUpdateEventArgs e)
        {
            ...
            if (dr == null) return;
            dr.id = (int)MyData.KlonsFQueriesTableAdapter.SP_BALA3_ID();
        }
