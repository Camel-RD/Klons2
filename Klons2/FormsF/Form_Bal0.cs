...
namespace KlonsF.Forms
{
    public partial class Form_Bal0 : MyFormBaseF
    {
        ...
        private void FormBal0_Load(object sender, EventArgs e)
        {
            ...
            MyData.DataSetKlonsF.Bal0.ColumnChanged += Bal0_ColumnChenged;
        }
        ...
        private void Bal0_ColumnChenged(object sender, DataColumnChangeEventArgs e)
        {
            ...
            if (e.Column == MyData.DataSetKlonsF.Bal0.SummCCColumn ||
                e.Column == MyData.DataSetKlonsF.Bal0.SummDCColumn ||
                e.Column == MyData.DataSetKlonsF.Bal0.CurColumn ||
                e.Column == MyData.DataSetKlonsF.Bal0.CurRateColumn)
            {
