...
namespace KlonsM.FormsM
{
    partial class FormM_Addresses
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.bsCountry = new KlonsLIB.Data.MyBindingSource(this.components);
            ...
            // bsCountry
            // 
            this.bsCountry.DataMember = "M_COUNTRIES";
            this.bsCountry.MyDataSource = "KlonsMData";
            ...
            // bsRows
            // 
            this.bsRows.DataMember = "FK_M_ADDRESSSES_IDSTORE";
