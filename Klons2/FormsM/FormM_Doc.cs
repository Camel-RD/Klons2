...
namespace KlonsM.FormsM
{
        ...
        IMyDgvTextboxEditingControlEvents2, IMyDgvTextboxEditingControlEvents
    {
        ...
        private void GetDocAccCellValue(KlonsLIB.MySourceGrid.GridRows.MyGridRowPickRowTextBox grow)
        {
        ...
        private void GetDocPVNTypeCellValue(KlonsLIB.MySourceGrid.GridRows.MyGridRowPickRowTextBox grow)
        {
            var id = (int)grow.Value;
