...
namespace KlonsA.Classes
{
    public static class DataLoader
    {
        ...
        {
            var ds = MyData.DataSetKlonsA;
            var dsr = MyData.DataSetKlonsARep;
        ...
        public static bool LoadPeriod(int yr1, int mt1, int yr2, int mt2)
        {
            ...
            var adDlSar = MyData.KlonsATableAdapterManager.TIMESHEET_LISTSTableAdapter;
            var adDlSarR = MyData.KlonsATableAdapterManager.TIMESHEET_LISTS_RTableAdapter;
            var adDarbaLaiks = MyData.KlonsATableAdapterManager.TIMESHEETTableAdapter;
            var adAlgasLapas = MyData.KlonsATableAdapterManager.SALARY_SHEETSTableAdapter;
            var adAlgasLapasR = MyData.KlonsATableAdapterManager.SALARY_SHEETS_RTableAdapter;
            var adAlgasPapildsummas = MyData.KlonsATableAdapterManager.SALARY_PLUSMINUSTableAdapter;
            var adGabd = MyData.KlonsATableAdapterManager.PIECEWORKTableAdapter;
            var adPayLists = MyData.KlonsATableAdapterManager.PAYLISTSTableAdapter;
            var adPayListsR = MyData.KlonsATableAdapterManager.PAYLISTS_RTableAdapter;
            var adFpPayLists = MyData.KlonsATableAdapterManager.FP_PAYLISTSTableAdapter;
            var adFpPayListsR = MyData.KlonsATableAdapterManager.FP_PAYLISTS_RTableAdapter;

            var tableSar = MyData.DataSetKlonsA.TIMESHEET_LISTS;
            var tableSarR = MyData.DataSetKlonsA.TIMESHEET_LISTS_R;
            var tableDarbaLaiks = MyData.DataSetKlonsA.TIMESHEET;
            var tableAlgasLapas = MyData.DataSetKlonsA.SALARY_SHEETS;
            var tableAlgasLapasR = MyData.DataSetKlonsA.SALARY_SHEETS_R;
            var tableAlgasPapildsummas = MyData.DataSetKlonsA.SALARY_PLUSMINUS;
            var tableGabd = MyData.DataSetKlonsA.PIECEWORK;
            var tablePayLists = MyData.DataSetKlonsA.PAYLISTS;
            var tablePayListsR = MyData.DataSetKlonsA.PAYLISTS_R;
            var tableFpPayLists = MyData.DataSetKlonsA.FP_PAYLISTS;
            var tableFpPayListsR = MyData.DataSetKlonsA.FP_PAYLISTS_R;

            MyData.DataSetKlonsA.EnforceConstraints = false;
            ...
            MyData.DataSetKlonsA.EnforceConstraints = true;
            ...
            MyData.DataSetKlonsA.PERSONS.DefaultView.Sort = "ID";
        ...
        public static bool LoadSomeData()
        {
            ...
            {
                var de = new DetailedConstraintException2(e.Message, MyData.DataSetKlonsA);
