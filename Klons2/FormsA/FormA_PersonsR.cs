...
namespace KlonsA.Forms
{
    public partial class FormA_PersonsR : MyFormBaseF
    {
        ...
        private void Form_PersonsR_Load(object sender, EventArgs e)
        {
            ...
            MyData.DataSetKlonsA.POSITIONS_PLUSMINUS.ColumnChanged += POSITIONS_PLUSMINUS_ColumnChanged;
        ...
        {
            if (e.Column == MyData.DataSetKlonsA.POSITIONS_PLUSMINUS.IDSVColumn)
            {
        ...
        private void AddPersonsRRow()
        {
            ...
            var table_pr = MyData.DataSetKlonsA.PERSONS_R;
        ...
        private void AddAmatiRRow()
        {
            ...
            var table_amr = MyData.DataSetKlonsA.POSITIONS_R;
        ...
        {
            var dr = MyData.DataSetKlonsA.PLUSMINUS_TYPES.FindByID(id);
            if (dr == null) return -1;
            return dr.TP1;
        }
        private int GetNotikumaVeidsTP1(int id)
        {
            var dr = MyData.DataSetKlonsA.EVENT_TYPES.FindByID(id);
            if (dr == null) return -1;
            return dr.TP1;
        }
        ...
        public void DoAddPosition()
        {
            ...
            var tableAmati = MyData.DataSetKlonsA.POSITIONS;
            var tableAmatiR = MyData.DataSetKlonsA.POSITIONS_R;
