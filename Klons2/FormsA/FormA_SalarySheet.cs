...
namespace KlonsA.Forms
{
    public partial class FormA_SalarySheet : MyFormBaseF
    {
        ...
        {
            if (e.Column == MyData.DataSetKlonsA.SALARY_PLUSMINUS.IDSVColumn)
            {
        ...
        private void OnSheetRowCurrentChanged()
        {
            ...
            {
                drv = new DataView(MyData.DataSetKlonsA.SALARY_SHEETS_R, null, null, DataViewRowState.None);
            ...
            var dv = new DataView(MyData.DataSetKlonsA.SALARY_SHEETS_R, filter, null, DataViewRowState.CurrentRows);
            ...
            var drvs_pers = MyData.DataSetKlonsA.PERSONS.DefaultView.FindRows(dr.PERSONSRow.ID);
        ...
        public void AddNewBonusRow()
        {
            ...
            var table_ps = MyData.DataSetKlonsA.SALARY_PLUSMINUS;
        ...
        {
            var table = MyData.DataSetKlonsA.SALARY_SHEETS_R;
            ...
            {
                MyData.KlonsAQueriesTableAdapter.SP_MAKE_SALARY_SHEET_R_HIST(row.ID, dt, MyData.SalaryCalcHistoryInterval);
            }
            ...
            foreach (var row in rows)
            {
                ...
                else
                {
                    ...
                    MyData.KlonsAQueriesTableAdapter.SP_MAKE_SALARY_SHEET_R_HIST_2(row.IDSX, dt, MyData.SalaryCalcHistoryInterval);
            ...
            KlonsADataSet.SALARY_SHEETS_R_HISTDataTable table_hist)
        {
            ...
            var table_lapas_r = MyData.DataSetKlonsA.SALARY_SHEETS_R;
        ...
        {  
            ...
            var dr_lapas_r = (bsSarR.Current as DataRowView)?.Row as KlonsADataSet.SALARY_SHEETS_RRow;
            if (dr_lapas_r == null) return;
            var ad = new KlonsF.DataSets.KlonsADataSetTableAdapters.SALARY_SHEETS_R_HISTTableAdapter();
