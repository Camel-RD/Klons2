...
namespace KlonsA.Forms
{
    public partial class FormA_TimeSheet : MyFormBaseF
    {
        ...
        private void TIMESHEET_ColumnChangedA(object sender, DataColumnChangeEventArgs e)
        {
            ...
            var k1 = MyData.DataSetKlonsA.TIMESHEET.V1Column.Ordinal;
            var k2 = MyData.DataSetKlonsA.TIMESHEET.V31Column.Ordinal;
            ...
            if (e.Column == MyData.DataSetKlonsA.TIMESHEET.K1Column)
            {
                SpreadHours(dr.K1);
                RefreshK1(dr);
                return;
        ...
        {
            var rr = MyData.DataSetKlonsA.TIMESHEET.WhereX(d =>
            {
        ...
        private void dgvLapa_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            if (e.ColumnIndex >= dgcV1.Index && e.ColumnIndex <= dgcV31.Index)
            {
                ...
                var jr = dgvLapa.Rows[e.RowIndex].DataBoundItem as TimeSheetJoinViewRow;
                var dr = jr.XRow;
                int dk = MyData.DataSetKlonsA.TIMESHEET.D1Column.Ordinal;
