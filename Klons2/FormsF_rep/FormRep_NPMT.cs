...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_NPMT : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            TRepMTTableAdapter ad1 = MyData.GetKlonsFRepAdapter("TRepMT") as TRepMTTableAdapter;
            if (ad1 == null) return;
            ...
            {
                case 0:
                    ad1.FillBy_npmt_14(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate);
                    MyData.ReportHelperF.PrepareTRepMTForNPMT1(endDate.Month);
                    rd.FileName = "Report_NPMT_1";
                    break;
                case 1:
                    ad1.FillBy_npmt_24(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate);
                    MyData.ReportHelperF.PrepareTRepMTForNPMT1(endDate.Month);
                    rd.FileName = "Report_NPMT_2";
                    break;
                case 2:
                    ad1.FillBy_npmt_44(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate);
                    MyData.ReportHelperF.PrepareTRepMTForNPMT1(endDate.Month);
                    rd.FileName = "Report_NPMT_1";
                    break;
                case 3:
                    ad1.FillBy_npmt_31(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate);
                    MyData.ReportHelperF.PrepareTRepMTForNPMT3();
                    rd.FileName = "Report_NPMT_3";
                    break;
            }


            rd.Sources["DataSet1"] = MyData.DataSetKlonsFRep.TRepMT;
