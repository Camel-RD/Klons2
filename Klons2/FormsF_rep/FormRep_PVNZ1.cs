...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_PVNZ1 : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            var ad1 = MyData.GetKlonsFRepAdapter("TREPPVNZ1") as TREPPVNZ1TableAdapter;
            if (ad1 == null) return;
            ...
            ad1.FillBy_PVNZ1(MyData.DataSetKlonsFRep.TREPPVNZ1, startDate, endDate);
            rd.FileName = "Report_PVNZ_1";

            MyData.ReportHelperF.PrepareTRepDarz1();

            rd.Sources["DataSet1"] = MyData.DataSetKlonsFRep.TREPPVNZ1;
