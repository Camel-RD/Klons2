...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_ApgrNP : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            if (cbCharCount.Text == "*")
            {
                ad.FillBy_apgr_np_11(MyData.DataSetKlonsFRep.ROps2a, startDate, endDate, ac);
            }
            else
            {
                ad.FillBy_apgr_np_12(MyData.DataSetKlonsFRep.ROps2a, startDate, endDate, ac, int.Parse(cbCharCount.Text));
            }
