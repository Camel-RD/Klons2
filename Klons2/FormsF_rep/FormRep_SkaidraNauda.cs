...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_SkaidraNauda : MyFormBaseF
    {
        ...
        private void DoIt(int k)
        {
            ...
            if(k == 1)
                ad.FillBy_skaidra_01(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, limit1, "JP");
            else
                ad.FillBy_skaidra_02(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, limit2, "FP");
