...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_PVNCheck : MyFormBaseF
    {
        ...
        private void DoIt(int repid)
        {
            ...
            var ad = MyData.GetKlonsFRepAdapter("ROps1a") as ROps1aTableAdapter;

            switch (repid)
            {
                case 1:
                    ad.FillBy_pvn_check_02(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, slieksnis, likme);
                    break;
                case 2:
                    ad.FillBy_pvn_check_01(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, slieksnis, likme);
                    break;
                default:
                    return;
            }
