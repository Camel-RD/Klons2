    ...
    public partial class FormRep_Apgr1 : MyFormBaseF
    {
        ...
        private void DoIt(bool doreport = true)
        {
            ...
            try
            {
                if (cbCharCount.Text == "*")
                {
                    ad.FillBy_apgr_11(MyData.DataSetKlonsFRep.ROps2a, startDate, endDate, ac);
                }
                else
                {
                    ad.FillBy_apgr_21(MyData.DataSetKlonsFRep.ROps2a, startDate, endDate, ac, int.Parse(cbCharCount.Text));
                }
