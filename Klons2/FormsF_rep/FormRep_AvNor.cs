...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_AvNor : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            ad1a.FillBy_koresp_11_clid2(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, ac, clid);
            ad2a.FillBy_apgr_01_clid2(MyData.DataSetKlonsFRep.ROps2a, startDate, endDate, ac, clid);
            ad3a.FillBy_koresp_01_clid2(MyData.DataSetKlonsFRep.ROps3a, startDate, endDate, ac, clid);
