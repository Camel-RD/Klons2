...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_ApgrMT : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            TRepMTTableAdapter ad = MyData.GetKlonsFRepAdapter("TRepMT") as TRepMTTableAdapter;
            if (ad == null) return;
            ...
            {
                case 0:
                    ad.FillBy_apgr_mt_11(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate, ac);
                    break;
                case 1:
                case 2:
                    ad.FillBy_apgr_mt_12(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate, ac);
                    break;
                case 3:
                    ad.FillBy_apgr_mt_21(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate, ac);
                    break;
                case 4:
                    ad.FillBy_apgr_mt_22(MyData.DataSetKlonsFRep.TRepMT, startDate, endDate, ac);
                    break;
            }

            MyData.ReportHelperF.PrepareTRepMT();
