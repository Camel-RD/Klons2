...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_ApgrFull : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            TRepApAnTableAdapter ad = MyData.GetKlonsFRepAdapter("TRepApAn") as TRepApAnTableAdapter;
            if (ad == null) return;

            ad.FillBy_apgr_full_11(MyData.DataSetKlonsFRep.TRepApAn, startDate, endDate,
                ac1, ac2, ac3, ac4, ac5, cl,
            ...
            rd.Sources["DataSet1"] = MyData.DataSetKlonsFRep.TRepApAn;
