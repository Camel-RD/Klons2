...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_KasesGr : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            {
                case 0:
                    ad1a.FillBy_kg_11(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, ac);
                ...
                case 1:
                    ...
                    break;
                case 2:
                    ad1a.FillBy_kieo_21(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, ac);
                    MyData.ReportHelperF.PrepareRops1aForKO();
                    rd.FileName = "Report_KIEO_1";
                    break;
                case 3:
                    ad1a.FillBy_kizo_21(MyData.DataSetKlonsFRep.ROps1a, startDate, endDate, ac);
                    MyData.ReportHelperF.PrepareRops1aForKO();
        ...
        private void cmNrKIEO_Click(object sender, EventArgs e)
        {
            ...
            var ad = MyData.KlonsFQueriesTableAdapter;
