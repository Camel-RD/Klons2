...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_PVNDekl : MyFormBaseF
    {
        ...
        private void DoCalc()
        {
            ...
            foreach (var dr in MyData.DataSetKlonsFRep.ROps2a)
            {
                sdeb[dr.Ac] = dr.TDb;
                skred[dr.Ac] = dr.TCr;
            }
        ...
        {
            ROps2aTableAdapter ad = MyData.GetKlonsFRepAdapter("ROps2a") as ROps2aTableAdapter;
            if (ad == null) return;

            ad.FillBy_pvn_10(MyData.DataSetKlonsFRep.ROps2a, startDate, endDate);
        ...
        {
            ROps1aTableAdapter ad = MyData.GetKlonsFRepAdapter("ROps1a") as ROps1aTableAdapter;
            if (ad == null) return;

            ad.FillBy_pvn_22(MyData.DataSetKlonsFRep.ROps1a,
        ...
        private void DoPVNPiel12T()
        {
            ...
            ad.FillBy_pvn_52(MyData.DataSetKlonsFRep.ROps1a,
                startDate, endDate, xsumma, xsumma);
        ...
        private void DoPVNPiel13T()
        {
            ...
            ad.FillBy_pvn_32(MyData.DataSetKlonsFRep.ROps1a,
                startDate, endDate, xsumma, xsumma);
        ...
        private void DoPVNPiel2T()
        {
            ...
            ad.FillBy_pvn_42(MyData.DataSetKlonsFRep.ROps1a,
                startDate, endDate, xsumma, xsumma);
        ...
        private void DoPVNPiel2Ta()
        {
            ...
            ad.FillBy_pvn_41(MyData.DataSetKlonsFRep.ROps1a,
                startDate, endDate, xsumma, xsumma);
        ...
        private bool DoXML(bool pvn2 = true)
        {
            ...
            ROps1aTableAdapter ad2 = MyData.GetKlonsFRepAdapter("ROps1a") as ROps1aTableAdapter;
