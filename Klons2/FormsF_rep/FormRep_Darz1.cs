...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_Darz1 : MyFormBaseF
    {
        ...
        private void FormRepApgr1_Load(object sender, EventArgs e)
        {
            ...
            var table_acp = MyData.DataSetKlonsF.AcP21;
        ...
        private string Check()
        {
            ...
            {
                filterAc1 = filter;
                var dr_ac = MyData.DataSetKlonsF.AcP21.FindByAC(filter);
                if(dr_ac != null)
                {
                    var ac3 = dr_ac.id1;
                    var ac = dr_ac.AC;
        ...
        private void DoIt()
        {
            ...
            TRepDarz1TableAdapter ad1 = MyData.GetKlonsFRepAdapter("TRepDarz1") as TRepDarz1TableAdapter;
            TRepDarz2TableAdapter ad2 = MyData.GetKlonsFRepAdapter("TRepDarz2") as TRepDarz2TableAdapter;
            if (ad1 == null) return;
            if (ad2 == null) return;
            ...
            MyData.ReportHelperF.PrepareTRepDarz1();

            rd.Sources["DataSet1"] = MyData.DataSetKlonsFRep.TRepDarz1;
            rd.Sources["DataSet2"] = MyData.DataSetKlonsFRep.TRepDarz2;
