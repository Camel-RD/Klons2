...
namespace KlonsA.Classes
{
    public class Report_IINk
    {
        ...
        public List<IINReportRow> MakeReport1(EReportType reporttype, DateTime dt1, DateTime dt2, DateTime dtx, bool simple)
        {
            ...
            var ad = new KlonsF.DataSets.KlonsARepDataSetTableAdapters.SP_REP_IINK_01TableAdapter();
            ...
            for (int i = 0; i < table.Rows.Count; i++)
            {
                ...
                var drp = MyData.DataSetKlonsA.PERSONS.FindByID(rr.idp);
        ...
        public List<IINReportRow> MakeReport2(EReportType reporttype, DateTime dt1, DateTime dt2)
        {
            ...
            var ad = new KlonsF.DataSets.KlonsARepDataSetTableAdapters.SP_REP_IINK_21TableAdapter();
            if (reporttype == EReportType.ForMonth)
            {
            ...
            for (int i = 0; i < table.Rows.Count; i++)
            {
                ...
                var drp = MyData.DataSetKlonsA.PERSONS_FIZ.FindByID(rr.idp);
                rr.PK = PKForRep(drp.PK);
                rr.Name = drp.FNAME + " " + drp.LNAME;
                ...
                rr.IncomeTypeS = MyData.DataSetKlonsA.INCOME_CODES
        ...
        {
            var dr = MyData.DataSetKlonsA.INCOME_CODES.FindByID(id);
            return dr.DESCR;
        }
    }
